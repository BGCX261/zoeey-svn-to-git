...
import org.zoeey.core.util.MemoryMeasurer;
...
public class AnalyzerTest extends TestCase {
    ...
    public void testAnalysis() {
        ...
        if (true) {
            ...
            analyzer = new Analyzer("\"value1\"", overlooker);
            analyzer.parse();
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("[\"value5\",\"value6\"]", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("{key1:\"value1\",key2:\"value2\""
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$var", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("@func", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("true", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("1+1", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$i+++1", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$i+++++$i", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("func($x,$y)", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$name|trim", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$isDebug?100:200", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$b=true==$i===1", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("$b=!$t!=$i!==1", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("128>8997", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("128*228/328%528", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("true && false", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("2  & 1", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("true  xor false", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("~255", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("5<<12", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
             ...
             */
            overlooker = new Overlooker("test.tpl");
            analyzer = new Analyzer("12>>5", overlooker);
            analyzer.parse();
            for (Token token : analyzer.getTokenStack()) {
                result.add(token.getType());
                result.add(token.getWords());
...
//        for (int i = 0; i < 10000; i++) {
         ...
         */
        overlooker = new Overlooker("test.tpl");
        analyzer = new Analyzer("[128*228/328%528,true,128>39,$i++"
