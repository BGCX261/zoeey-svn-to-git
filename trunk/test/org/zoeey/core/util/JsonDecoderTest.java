 ...
 * $Id: JsonDecoderTest.java 75 2010-03-16 02:21:41Z MoXie $
 *
...
import org.zoeey.core.util.JsonDecoder.Validator;
...
public class JsonDecoderTest {
    ...
    public void testDecode_String() throws IOException {
        ...
        jsonStr = TextFileHelper.read(new File(
                TestUtil.getResource("org/zoeey/core/util/JsonDecoderTest.json") //
                ));
        result = JsonDecoder.decode(jsonStr);
        JsonDecoder.decode(jsonStr);
