...
import org.zoeey.core.util.ImageHelper.ImgSize;
...
public class ImageHelperTest {
    ...
    public void testResize() throws Exception {
        ...
        File originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/rendering.jpg"));
        File resizedImg_force_small = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/rendering_resized-froce-small.jpg"));
        File resizedImg_force_big = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/rendering_resized-froce-big.jpg"));
        File resizedImg_suite_small = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/rendering_resized-suite-small.jpg"));
        File resizedImg_suite_big = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/rendering_resized-suite-big.jpg"));
...
//
        ...
        assertFalse(ImageHelper.resize(originImg, resizedImg_suite_big, targetSize));
         ...
         *
         */
        originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/alpha.png"));
        resizedImg_suite_small = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/alpha_resized.png"));
        width = 11;
        height = 11;
        targetSize = new ImgSize(width, height);
    ...
    public void testWatermark() throws Exception {
        ...
        File originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/rendering.jpg"));
        File markedImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/rendering_marked.jpg"));
         ...
         */
        originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/alpha.png"));
        markedImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/alpha_marked.png"));
        x = 188;
        y = 180;
        alpha = 1.0f;
        expResult = true;
    ...
    public void testDrawLine() throws Exception {
        ...
        File originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/rendering.jpg"));
        File writedImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/rendering_writed.jpg"));
        ...
        originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/z.png"));
        writedImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/z_writed.png"));
         ...
         */
        originImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/alpha.png"));
        writedImg = new File(TestUtil.getResourceDir().concat("/imageHelperTest/temp/alpha_writed.png"));
        line = "Zoeey".toCharArray();
        x = 1;
        y = 11;
        alpha = 0.9F;
