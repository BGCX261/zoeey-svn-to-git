 ...
 * $Id: WebValidatorTest.java 69 2009-12-15 12:25:04Z MoXie $
 *
...
public class WebValidatorTest {
    ...
    public void testIsTitle_NO() {
        ...
        boolean result = WebValidator.isTitle_NO(title);
        assertEquals(expResult, result);
    ...
    public void testIsTitle_StringArr() {
        ...
        boolean expResult = false;
        boolean result = WebValidator.isTitle(titleList);
        assertEquals(expResult, result);
    ...
    public void testIsShortCode() {
        ...
        String code = "";
        boolean expResult = false;
        boolean result = WebValidator.isShortCode(code);
        assertEquals(expResult, result);
    ...
    public void testIsShortCode_NO() {
        ...
        String code = "";
        boolean expResult = true;
        boolean result = WebValidator.isShortCode_NO(code);
        assertEquals(expResult, result);
    ...
    public void testIsContent_NO() {
        ...
        String content = "";
        boolean expResult = true;
        boolean result = WebValidator.isContent_NO(content);
        assertEquals(expResult, result);
    ...
    public void testIsContent_StringArr() {
        ...
        boolean expResult = false;
        boolean result = WebValidator.isContent(contentList);
        assertEquals(expResult, result);
    ...
    public void testIsFormatTime_NO() {
        ...
        String time = "";
        boolean expResult = true;
        boolean result = WebValidator.isFormatTime_NO(time);
        assertEquals(expResult, result);
    ...
    public void testIsFormatDate_NO() {
        ...
        String time = "";
        boolean expResult = true;
        boolean result = WebValidator.isFormatDate_NO(time);
        assertEquals(expResult, result);
    ...
    public void testIsPassword_NO() {
        ...
        String psw = "";
        boolean expResult = true;
        boolean result = WebValidator.isPassword_NO(psw);
        assertEquals(expResult, result);
