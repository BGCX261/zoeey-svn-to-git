 ...
 * $Id: FieldMapperTest.java 69 2009-12-15 12:25:04Z MoXie $
 *
...
//        mm.stop();
        ...
        fieldMap = FieldMapper.toFieldMap(map, false);
        assertEquals(fieldMap.toString(),//
                "{name[key_1][key_2][2]=bb, name[key_1][key_2][1]=aa, name={key_1={key_2={2=bb, 1=aa}}}}");
