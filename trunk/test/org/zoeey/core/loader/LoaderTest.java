 ...
 * $Id: LoaderTest.java 70 2010-01-02 20:08:07Z MoXie $
 *
...
import org.zoeey.core.loader.fileupload.FileError;
...
import org.zoeey.core.validator.standards.EmailVali;
...
public class LoaderTest extends TestCase {
    ...
    public void testFetch() throws Exception {
        ...
        Loader loader = new Loader(ic.getRequest());
        User user = new User();
        ...
        loader = new Loader(ic.getRequest());
        ...
        loader = new Loader(ic.getRequest(), config);
        loader.load(user);
