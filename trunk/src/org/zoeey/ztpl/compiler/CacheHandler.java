 ...
 * $Id: CacheHandler.java 76 2010-03-19 03:21:03Z MoXie $
 *
...
import org.zoeey.ztpl.compiler.CompileHelper;
...
public class CacheHandler {
     ...
     * @return
     */
    private File genCacheFile() {
        StringBuilder strBuilder = new StringBuilder(50);
        strBuilder.append(config.getCacheDir().getAbsolutePath());
        strBuilder.append('/');
        strBuilder.append(CompileHelper.genIdentifier("cache_", tplFile.getParent()));
        strBuilder.append('/');
        strBuilder.append(CompileHelper.genClassName("cache_", tplFile));
