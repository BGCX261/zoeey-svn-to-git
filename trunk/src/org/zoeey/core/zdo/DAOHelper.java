 ...
 * $Id: DAOHelper.java 80 2010-07-15 01:50:02Z MoXie $
 *
...
import org.zoeey.core.util.KeyValueFile;
import org.zoeey.core.util.MapHelper;
import org.zoeey.core.util.ReflectCacheHelper;
import org.zoeey.core.util.StringHelper;
import org.zoeey.core.zdo.exceptions.DAOBindBeanException;
import org.zoeey.core.zdo.zdbcontrol.ZDBControlMixed;
...
public class DAOHelper {
    ...
    /**
     * 获取第一个字段
     * @see #getGeneratedKeys(org.zoeey.core.zdo.DAOHelper.ListHandler)
     */
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        for (int i = 1; i <= rsmd.getColumnCount(); i++) {
                            ...
                            method = methodMap.get(columnName);
     ...
     * @return  无结果时返回 null
     * @throws SQLException
     * @see #exec(org.zoeey.core.zdo.DAOHelper.ListHandler) 
     */
     ...
     * @return  无结果时返回 null
     * @throws SQLException
     * @see #exec(org.zoeey.core.zdo.DAOHelper.ObjectHandler) 
     */
