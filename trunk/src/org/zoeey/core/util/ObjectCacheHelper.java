 ...
 * $Id: ObjectCacheHelper.java 78 2010-04-30 02:10:36Z MoXie $
 *
...
public class ObjectCacheHelper {
     ...
     * 默认域
     * ex.
     *  private static String CACHE_DOMAIN = "org.zoeey.core.util.ReflectCacheHelper";
     */
    private static final String DEFAULT_DOMAIN = "org.zoeey.core.util.ObjectCacheHelper";
    /**
     *  
     */
     ...
     * get("keyName")
     * 等同于
     * get("org.zoeey.core.util.ObjectCacheHelper","keyName");
     * </pre>
     * @param <V> 返回对象类型
     * @param key 
     * @return 无值返回 null
     ...
     * 等同于
     * put("org.zoeey.core.util.ObjectCacheHelper"，"keyName","bigValue");
     * </pre>
     * @param key   不可为空
     * @param value 需要缓存的对象
     */
     ...
     * remove("keyName");
     * 等同于
     * remove("org.zoeey.core.util.ObjectCacheHelper","keyName");
     * </pre>
     * @param key 键
     */
     ...
     * 清理域所有缓存
     * ex.
     * removeAll("org.zoeey.core.util.ObjectCacheHelper");
     * 等同于
