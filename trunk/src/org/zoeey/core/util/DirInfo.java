 ...
 * $Id: DirInfo.java 71 2010-01-07 05:49:47Z MoXie $
 *
    ...
    private static String initClassesDir() {
        ...
        do {
            ...
            if (webInfoURL != null) {
                ...
                classRoot = classRoot.replaceFirst("org/zoeey/core/util", "");
                break;
            }
            /**
             * tomcat
            ...
            if (classRoot == null || classRoot.indexOf("classes") == -1) {
                classRoot = DirInfo.class.getClassLoader().getResource("/").getPath();
            }
