 ...
 * $Id: QueryStringHelper.java 76 2010-03-19 03:21:03Z MoXie $
 * 
...
public class QueryStringHelper {
    ...
    public static Map<String, String> toMap(String str) {
        QueryStringHelper queryStringHelper = new QueryStringHelper(str);
        return queryStringHelper.getMap();
    }
    ...
    public static Collection<Entry<String, String>> toFieldList(String str) {
        QueryStringHelper queryStringHelper = new QueryStringHelper(str);
        return queryStringHelper.getFieldList();
    }
    ...
    public static Map<String, String> toMap(String str, String charset) {
        QueryStringHelper queryStringHelper = new QueryStringHelper(str, charset);
        return queryStringHelper.getMap();
    }
