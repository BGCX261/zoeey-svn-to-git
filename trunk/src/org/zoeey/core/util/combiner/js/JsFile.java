 ...
 * $Id: JsFile.java 75 2010-03-16 02:21:41Z MoXie $
 *
...
public class JsFile implements Cloneable{
    ...
    public String toString() {
        ...
        // fileRoot
        strBuffer.append("{fileRoot:\"").append(fileRoot).append("\"},");
        // isStatic
        strBuffer.append("{isStatic:").append(isStatic).append("},");
        // isDebug
        strBuffer.append("{isDebug:").append(isDebug).append("},");
        // charset
        strBuffer.append("{charset:").append(charset).append('}');
        strBuffer.append(']');
